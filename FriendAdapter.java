...
public class FriendAdapter  extends RecyclerView.Adapter<FriendAdapter.ViewHolder>{
    ...
    private static FriendAdapter.shareData activity;
    private FirebaseDatabase database;
    private DatabaseReference myRef;
    private FirebaseAuth mAuth;
    private User loggedInUser;

    public FriendAdapter(Context context, List<User> pods, int mResource, FriendAdapter.shareData activity, User loggedInUser) {
        this.mPodcasts = pods;
    ...
    public FriendAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        FriendAdapter.ViewHolder viewHolder = new FriendAdapter.ViewHolder(contactView);
        return viewHolder;
    }
    ...
    public void onBindViewHolder(FriendAdapter.ViewHolder holder, final int position) {
        ...
        right.setImageResource(R.drawable.remove_friend);

        right.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                activity.removeFriend(pod);
            }
        });
